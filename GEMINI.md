...
- 001-auto-refresh-forecast: Added Node.js (as per project environment), Astro (^5.16.8), React (18.2.0) + Astro.js, React, Tailwind CSS, Vitest (for unit tests), Playwright (for E2E tests). No new primary dependencies for this feature.
