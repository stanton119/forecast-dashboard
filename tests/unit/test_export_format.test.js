...
describe('CSV export formatting', () => {
  it('should correctly format an array of data into CSV string', () => {
    const testData = [
      {
        timestamp_iso: '2026-01-12T10:00:00Z',
        outside_humidity_percent: 70,
        outside_temp_c: 10,
        inside_relative_humidity_percent: 50,
      },
      {
        timestamp_iso: '2026-01-12T11:00:00Z',
        outside_humidity_percent: 72,
        outside_temp_c: 11,
        inside_relative_humidity_percent: 52,
      },
    ];
    const expectedCsv =
      'Date,Time,Outdoor Humidity (%),Outdoor Temp (C),Indoor RH (%)\n' +
